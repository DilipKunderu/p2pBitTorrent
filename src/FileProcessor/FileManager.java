...
public class FileManager {
    ...
    private void sendFilePart(int filePart, Socket socket) throws IOException {
        File fileToSend;
    ...
    private void getFilePart(int filePart, Socket socket) throws IOException {
